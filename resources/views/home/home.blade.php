    ...
    <div class="topbar">
        <div class="container">
            ...
            <div class="topbar-info">
                ...
                <a class="link">消息通知</a>
                @else
                <a href="/home/login" class="link">
                {{session('phone')}}</a>
                <a href="/logout" class="link">退出</a>
                <a href="/order" class="link">我的订单</a>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="header">
        <div class="container">
            ...
            <div class="header-nav center">
                <ul class="navlist clearfix" style="position: absolute;">
                    @section('all')
					...
					@foreach($nava as $k => $v)
	                    <li class="mainnav-item">
	                        <div class="product-thumb">
	                            <a href="#"><img src="{{$v->fig}}" width="120px" height="130px;"></a>
	                        </div>
	                        <div class="title">
	                            <a href="#">{{$v->title}}</a>
	                        </div>
...
<div class="site-info">
    <div class="container">
        ...
        <div class="info-text">
            ...
            <?php 
                $infor = DB::table('infor')->get();
            ?>
            <p>
                ©<a href="#"></a> 京ICP证110507号 
