...
<html lang="en">
  <head>
    ...
    <!-- full calendar css-->
    <link href="/admins/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css" rel="stylesheet" />
	<link href="/admins/assets/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" />
    <!-- easy pie chart-->
...
<!-- container section start -->
    <section id="container" class="">
        ...
        <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">backstage <span class="lite">Admin</span></a>
            <!--logo end-->
        ...
        <section id="main-content">
            <section class="wrapper">            
                <div class="row">
                    <div class="col-lg-12">
                        @section('title')
                        <h3 class="page-header"><i class="fa fa-laptop"></i> 登录记录</h3>
                        @show
                        <ol class="breadcrumb">
  ...
  <!-- container section start -->
    ...
    <script type="text/javascript" src="/admins/js/jquery-ui-1.9.2.custom.min.js"></script>
    <!-- bootstrap -->
	...
	<script src="/admins/assets/fullcalendar/fullcalendar/fullcalendar.js"></script>
	...
	<script src="/admins/assets/chart-master/Chart.js"></script>
