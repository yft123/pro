...
@section('content')
<div class="row">
	<form action="/Singlegoods" class="navbar-form">
              <div class="row">
                  <div class="col-sm-6">
  	...
  	<div class="col-lg-12">
      	<section class="panel">          	          
          	<table class="table table-striped table-advance table-hover">
                  ...
                  @if(count($Singlegoods) > 0)
              		@foreach ($Singlegoods as $k => $v)
              		<tr class="col-md-12">
                    ...
                    <td class="col-md-1">{{$v->kucun}}</td>
                 		...
                 		<td>
                  		<div class="btn-group">
                      		<a class="btn btn-primary" href="/Singlegoods/{{$v->id}}/edit"><i class="icon_plus_alt2"></i></a>
                          	
                            <form class="del" action="/Singlegoods/{{$v->id}}" method="post" style="float:left">
                            {{method_field('DELETE')}}
                            {{csrf_field()}}
        	...
        	<div class="row">
                        <div class="col-lg-12 text-right">
                            <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                {{ $Singlegoods->appends(['num'=>$num, 'keywords'=>$keywords])->links() }}
                            </div>
                        </div>
                    </div>
      	</section>
